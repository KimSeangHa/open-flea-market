<template>
    ...
    >
            ...
            >
                ...
                >
                    <v-card
                        class="mx-auto justify-center main-card"
                        outlined
                    ...
                    > 
                            <v-card-title>
                                ...
                                -->
                                <span class="font-weight-bold">이번주 프리마켓 현황</span>
                        </v-card-title>
            ...
            <div
                class="d-inline-block main-card-form main-card-line-2 justify-center text-center margin-0-auto"
            >
                <v-hover
                    v-slot="{ hover }"
                    open-delay="0"
